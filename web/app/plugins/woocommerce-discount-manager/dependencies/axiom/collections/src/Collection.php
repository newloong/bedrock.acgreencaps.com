...
namespace Barn2\Plugin\Discount_Manager\Dependencies\Axiom\Collections;

use Countable;
use ArrayAccess;
use ArrayIterator;
use IteratorAggregate;
use Barn2\Plugin\Discount_Manager\Dependencies\Axiom\Collections\Support\Arr;
use Barn2\Plugin\Discount_Manager\Dependencies\Axiom\Collections\Contracts\Collection as CollectionContract;
class Collection implements CollectionContract, ArrayAccess, Countable, IteratorAggregate
{
    ...
    {
        $items = $this->items;
        $callback ? \uksort($items, $callback) : \ksort($items);
        return new static($items);
    }
    /**
