...
namespace Barn2\Plugin\Discount_Manager\Dependencies\Axiom\Collections\Support;

use RecursiveArrayIterator;
use RecursiveIteratorIterator;
use Barn2\Plugin\Discount_Manager\Dependencies\Axiom\Collections\Contracts\Collection;
class Arr
{
    /**
