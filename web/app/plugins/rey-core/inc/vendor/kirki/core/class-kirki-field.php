...
class Kirki_Field {
	...
	protected $help_tooltip;
	protected $help;
	protected $separator;
	protected $load_choices;
	protected $row_label;
	protected $button_label;
	protected $ajax_choices;
	protected $edit_preview;
	protected $show_variants;
	protected $notice_type;
	protected $rey_group_start;
	protected $rey_group_end;
	protected $group_id;
	protected $default_tablet;
	protected $default_mobile;
	protected $rey_preset;
	protected $open;
