...
/**
 * Override the default buttons tab in Elementor Site settings.
 * The default selectors contain selectors which are affecting the entire site (button, input type button, input type submit) and conflicts with the theme styles because the kit selector is overly specific.
 * This override only allows `elementor-button` selector to be styled.
 */

class KitButtons extends \Elementor\Core\Kits\Documents\Tabs\Tab_Base {
