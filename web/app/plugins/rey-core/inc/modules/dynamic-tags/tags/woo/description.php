...
class Description extends \ReyCore\Modules\DynamicTags\Tags\Tag {

	public static function __config() {
		return [
			'id'         => 'product-description',
			'title'      => esc_html__( 'Product Description', 'rey-core' ),
			'categories' => [ 'text' ],
	...
	public function render() {
		...
		if( ! ($product = TagDynamic::get_product($this)) ){
			return TagDynamic::display_placeholder_data( esc_html__( '{Product Description}', 'rey-core' ) );
		}
